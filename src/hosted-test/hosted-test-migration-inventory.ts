...
const NODE_HOSTED_SUITES: readonly HostedMigrationInventoryEntry[] = Object.freeze([
  ...
  hosted("livehost/core", 20, "all_node_safe_hosted_test_suites"),
  hosted("livehost/socket", 16, "all_node_safe_hosted_test_suites"),
  hosted("livehost/sync", 9, "all_node_safe_hosted_test_suites"),
  hosted("livehost/client", 27, "all_node_safe_hosted_test_suites"),
  hosted("livehost/pair", 13, "all_node_safe_hosted_test_suites"),
