    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    ...
                    oldGetterStillWorks: box.css.get.var("theme-ink"),
            ...
            assert(tree, t) {
                ...
                t.eq("existing css.get.var still reads same declaration", r.oldGetterStillWorks, "rgb(1, 2, 3)");
    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    ...
                    oldGetterStillWorks: box.style.get.var("runtime-x"),
            ...
            assert(tree, t) {
                ...
                t.eq("existing style.get.var still reads same declaration", r.oldGetterStillWorks, "12px");
    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    ...
                    cssOldGetter: box.css.get.var("shared-name"),
                    styleOldGetter: box.style.get.var("shared-name"),
                };
            },
    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    ...
                    oldGetterStillWorks: before.get.var("before-ink"),
            ...
            assert(tree, t) {
                ...
                t.eq("selector get.var still reads stored custom property", r.oldGetterStillWorks, "rgb(4, 5, 6)");
    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    ...
                    oldGetterAfter: box.css.get.var("gone"),
                };
            },
            ...
            assert(tree, t) {
                ...
                t.eq("css get.var returns undefined after null removal", r.oldGetterAfter, undefined);
            },
        },
        {
            suite: SUITE,
    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    ...
                    oldGetterAfter: box.style.get.var("gone"),
            ...
            assert(tree, t) {
                ...
                t.eq("style get.var returns undefined after null removal", r.oldGetterAfter, undefined);
...
export function livetree_get_many_surface(): TestSuite {
    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    allPropertyDirect: box.style.getMany(),
            ...
            assert(tree, t) {
                ...
                t.eq("style getMany reads CSS all property", r.allPropertyDirect, "unset");
    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    allPropertyDirect: box.css.getMany(),
            ...
            assert(tree, t) {
                ...
                t.eq("css getMany reads CSS all property", r.allPropertyDirect, "initial");
    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    allPropertyDirect: before.getMany(),
            ...
            assert(tree, t) {
                ...
                t.eq("selector getMany reads CSS all property", r.allPropertyDirect, "revert");
    ...
    `,
            ...
            async act(tree) {
                ...
                (tree as any).__result = {
                    ...
                    targetAll: target.style.getMany(),
