...
expect_registry(nodeAll.ok && nodeAll.summary.suites === 43 && nodeAll.summary.cases === 1087, "registered aggregate runner passes every Node-safe case exactly once");
...
expect_registry(hostedAll.ok && hostedAll.summary.suites === 127 && hostedAll.summary.cases === 2102 && hostedAll.summary.pass === 2102, "registered complete runner passes every canonical hosted case exactly once");
