...
import { $grn_, $ylw_, ACID_WASH_RGBA, ACID_WASH_OKLCH } from "../../app/core/consts/colors.consts";
...
import { ROW_CONTAINERcss, CONTROL_ROWcss, TEST_SELECTcss, RUN_BUTTONcss, CLEAR_BTNcss, TEST_LOGGERcss, TEST_CONTENTcss, TEST_INSPECTOR_PANEcss, TEST_LOG_PANEcss, TP_ROOTcss } from "./tp.css";
...
function test_panel_factory(): Outcome<TestPanel> {
    ...
    const makeLogRow = (line: string): LiveTree => {
