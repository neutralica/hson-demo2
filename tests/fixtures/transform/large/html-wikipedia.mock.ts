// html-wikipedia.mock.hson-showcase.ts

export const html_wikisnip = `	<nav class="vector-main-menu-landmark" aria-label="Site">
...
<div class="rt-overlay"></div><div id="mw-teleport-target" class="vector-body"></div><a accesskey="v" href="https://en.wikipedia.org/wiki/Main_Page?action=edit" class="oo-ui-element-hidden"></a></body>`


export const hack_scripts_simpler =`
<body class="">            
