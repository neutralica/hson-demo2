...
export const BROWSER_SUITE_MANIFEST = Object.freeze([
  ...
  browser_suite("frozen-test-panel", [
    "Tests open fetches root and materializes category rows only",
    "category, suite, and case disclosures fetch and release exactly their owned level",
    "every frozen final report exclusively owns the inspector viewport",
    "direct suite and case URLs traverse only their owning hierarchy",
    "Copy Reports stays root-only and category failures remain localized",
    "a late category response cannot resurrect a closed disclosure",
    "a late suite response cannot resurrect disposed case rows",
    "frozen explorer accents remain shared palette values",
  ]),
