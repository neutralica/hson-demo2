...
import {
  NODE_LOCUS_MOTHERSHIP_EXECUTOR,
  make_local_node_locus_executor_registry,
  make_node_locus_mothership_executor_registry,
...
export async function run_fresh_node_selected_test_ids(
  ...
  const registry = advertisedRegistry.executor.id === NODE_LOCUS_MOTHERSHIP_EXECUTOR.id
    ? make_node_locus_mothership_executor_registry()
    : make_local_node_locus_executor_registry();
