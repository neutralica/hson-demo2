...
const DEMO_TEST_SCRIPTS = Object.freeze({
  ...
  "test:hosted-replay-node": "src/tests/livehost-tests/run-hosted-replay-action.node.mts",
  "test:hosted-report-node": "src/tests/livehost-tests/run-hosted-test-report.node.mts",
  "test:hosted-report-wire-node": "src/tests/livehost-tests/run-hosted-test-report-wire.node.mts",
  "test:hosted-report-protocol-node": "src/tests/livehost-tests/run-hosted-test-report-protocol.node.mts",
  "test:hosted-report-initial-node": "src/tests/livehost-tests/run-hosted-test-report-initial.node.mts",
  "test:hosted-report-mirror-node": "src/tests/livehost-tests/run-hosted-test-report-mirror.node.mts",
  "test:hosted-report-router-node": "src/tests/livehost-tests/run-hosted-test-report-router.node.mts",
  "test:hosted-replay-router-node": "src/tests/livehost-tests/run-hosted-replay-router.node.mts",
  "test:hosted-test-panel-adapter-node": "src/tests/livehost-tests/run-hosted-test-panel-adapter.node.mts",
  "test:hosted-test-panel-projection-node": "src/tests/livehost-tests/run-hosted-test-panel-projection.node.mts",
  "test:hosted-suite-registry-node": "src/tests/livehost-tests/run-hosted-suite-registry.node.mts",
  "test:hosted-node-all-node": "src/tests/livehost-tests/run-hosted-node-all.node.mts",
  "test:hosted-report-batch-node": "src/tests/livehost-tests/run-hosted-test-report-batch.node.mts",
  "test:hosted-report-performance-node": "src/tests/livehost-tests/run-hosted-report-performance.node.mts",
  "test:hosted-real-websocket-node": "src/tests/livehost-tests/run-hosted-real-websocket.node.mts",
  ...
  "test:hosted-dom-compatibility-node": "src/tests/livehost-tests/run-hosted-dom-compatibility.node.mts",
  "test:hosted-dom-real-websocket-node": "src/tests/livehost-tests/run-hosted-dom-real-websocket.node.mts",
  "test:hosted-stale-suite-real-websocket-node": "src/tests/livehost-tests/run-hosted-stale-suite-real-websocket.node.mts",
  "test:hosted-dom-behavior-diagnostics-node": "src/tests/livehost-tests/run-hosted-dom-behavior-diagnostics.node.mts",
  "test:hosted-dom-layout-diagnostics-node": "src/tests/livehost-tests/run-hosted-dom-layout-diagnostics.node.mts",
  "test:hosted-sanitizer-node": "src/tests/livehost-tests/run-hosted-sanitizer.node.mts",
  "test:hosted-canvas-runtime-node": "src/tests/livehost-tests/run-hosted-canvas-runtime.node.mts",
  "test:hosted-canvas-collection-node": "src/tests/livehost-tests/run-hosted-canvas-collection.node.mts",
  "test:hosted-canvas-real-websocket-node": "src/tests/livehost-tests/run-hosted-canvas-real-websocket.node.mts",
  "test:hosted-all-real-websocket-node": "src/tests/livehost-tests/run-hosted-all-real-websocket.node.mts",
  "test:hosted-case-inspection-node": "src/tests/livehost-tests/run-hosted-case-inspection.node.mts",
  "test:hosted-test-timing-node": "src/tests/livehost-tests/run-hosted-test-timing.node.mts",
  "test:hosted-multi-suite-concurrent-node": "src/tests/livehost-tests/run-hosted-multi-suite-concurrent.node.mts",
  "test:hosted-app-boundary-node": "src/tests/livehost-tests/run-hosted-app-boundary.node.mts",
  "test:hosted-run-identity-node": "src/tests/livehost-tests/run-hosted-run-identity.node.mts",
  "test:hosted-retry-classification-node": "src/tests/livehost-tests/run-hosted-retry-classification.node.mts",
  "test:livetree-lifecycle-foundations-node": "src/tests/livehost-tests/run-livetree-lifecycle-foundations.node.mts",
  "test:livetree-lifecycle-public-node": "src/tests/livehost-tests/run-livetree-lifecycle-public.node.mts",
  "test:livetree-lifecycle-ownership-node": "src/tests/livehost-tests/run-livetree-lifecycle-ownership.node.mts",
  "test:livetree-allocation-node": "src/tests/livehost-tests/run-livetree-allocation.node.mts",
  "test:hson-node-representation-node": "src/tests/livehost-tests/run-hson-node-representation.node.mts",
  "test:generated-json-node": "src/tests/diagnostics/run-generated-json.node.mts",
  "test:hosted-replay-events-node": "src/tests/livehost-tests/run-hosted-replay-events.node.mts",
  "test:hosted-replay-concurrent-node": "src/tests/livehost-tests/run-hosted-replay-concurrent.node.mts",
  ...
  "test:canonical-node": "src/tests/test-system/run-canonical-tests.node.mts",
  "test:stage2-contracts-node": "src/tests/test-system/run-stage-2-contracts.node.mts",
  "test:stage3-discovery-node": "src/tests/test-system/run-stage-3-discovery.node.mts",
  "test:stage4a-selected-node": "src/tests/test-system/run-stage-4a-selected.node.mts",
  "test:stage4a-selected-worker": "tests/cloudflare/run-hosted-cloudflare.node.mts",
  "test:stage4b-panel-node": "src/tests/test-system/run-stage-4b-panel.node.mts",
