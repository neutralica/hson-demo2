...
expect_events(Object.keys(result).sort().join(",") === "attemptId,ok,runId,suite,summary,timing", "action result includes attempt identity and authoritative host timing");
