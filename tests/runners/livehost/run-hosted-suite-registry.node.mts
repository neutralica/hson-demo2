...
expect_registry(livehost.ok && livehost.summary.suites === 14 && livehost.summary.cases === 202, "registered LiveHost runner passes 202 cases under Node");
expect_registry(nodeAll.ok && nodeAll.summary.suites === 62 && nodeAll.summary.cases === 1435, "registered aggregate runner passes every Node-safe case exactly once");
...
expect_registry(hostedAll.ok && hostedAll.summary.suites === 145 && hostedAll.summary.cases === 2428 && hostedAll.summary.pass === 2428, "registered complete runner passes every canonical hosted case exactly once");
