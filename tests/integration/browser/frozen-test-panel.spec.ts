...
test("frozen panel loads one immutable index and presents all authoritative groups without live acquisition", async ({ page }) => {
  ...
  await page.getByTestId("frozen-category-semantic").locator(".frozen-test-category-heading").click();
  await page.locator('[data-frozen-suite="semantic/suite-000"]').getByTestId("frozen-suite-row").click();
  await page.locator('[data-frozen-case="semantic/suite-000::case-001"]').click();
